...
public class RestTicketTypeController {
	...
	public ResponseEntity<TicketType> createTicketType(@RequestBody TicketType ticketType) {
		...
		try {
			TicketType _ticketType = repository
					.save(new TicketType(ticketType.getPrice(), ticketType.getCustomerType(), ticketType.getDescription()));
	...
	public ResponseEntity<TicketType> updateTicketType(@PathVariable("id") Long typeId, @RequestBody TicketType ticketType) {
